...
# REKOR-signing-key
Source4: https://gitlab.com/redhat/centos-stream/rpms/containers-common/-/raw/c10s/REKOR-signing-key
...
install -Dp -m0644 %{SOURCE4} %{buildroot}%{_sysconfdir}/pki/sigstore/REKOR-signing-key
%endif
